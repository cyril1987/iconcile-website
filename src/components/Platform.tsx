  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto bg-surface border border-border rounded-2xl shadow-2xl"
      >
        {/* Top color accent */}
        <div
  ...
  return (
    <section id="platform" ref={sectionRef} className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6 mb-16">
